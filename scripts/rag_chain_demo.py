...
"Static info only; do not invent live times. Cite the source filenames in
brackets."
)
...
# Offline stub LLM: just echoes context. Replace with your ChatOpenAI / Ollama
later.
class EchoLLM:
...
{"question": RunnablePassthrough(), "context": lambda x:
format_docs(x["docs"])) |
prompt | (lambda x: llm.invoke(x))
)
